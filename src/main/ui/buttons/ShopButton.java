...
public class ShopButton extends JButton {
    public static final String SHOP_BUTTON_ICON_SOURCE = "./data/graphics/shopIcon.png";
    ...
    public ShopButton(int frameContentPaneWidth, int frameContentPaneHeight) {
...
//        setForeground(Color.WHITE);
        ImageIcon imageIcon = new ImageIcon(SHOP_BUTTON_ICON_SOURCE);
        ...
        setBounds(
                frameContentPaneWidth - (2 * frameContentPaneHeight / 7),
